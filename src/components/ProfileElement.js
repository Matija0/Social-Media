...
import { useAuth } from "../pages/Auth/checkAuth";
  ...
  return (
    <>
      <div
        className={
          theme === "light"
            ? "hidden bg-white rounded-lg h-fit px-3 py-2 space-y-2 md:block"
            : "hidden bg-zinc-800 rounded-lg h-fit px-3 py-2 space-y-2 md:block text-gray-300"
        }
      >
        <div>
          ...
          />
          <div>
            <h1 className="text-lg font-bold">{userId}</h1>
